...
const RegistrationSuccessfull = ({setIsRegistered}) => {
  const handleOnClick = () => {
  ...
  return (
    <div className="z-50 fixed inset-0 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white p-6 rounded-lg shadow-2xl w-6/12 text-center">
        <h2 class="text-2xl font-bold mb-4 text-center">Registered Successfully</h2>
        <p class="mb-4 text-center">Click below to log in now</p>
